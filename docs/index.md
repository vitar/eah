...
Software teams use multiple estimation methods — FTEs, story points, sprints, velocity, cost models, forecasting ranges — but none of them speak the same language.
...
Below is a quick start overview.

---

# 📘 **Quick Start Guide**

## **Page 1 — The Model: Complexity & Uncertainty Framework**
...
## **Page 3 — Scoring Sheet Framework**
...
## **Page 4 — Estimation & Delivery Diagnostic**
...
## **Page 5 — Implementation Stages Plan**
...
1. **Start with [The Model](100-model.md)** → understand the model
2. **Move to [The Map](110-map.md)** → understand the translation relationships
